define(['services/requester'],
    function (requester) {
        ...
        var vm = {
            ...
            title: ko.observable('Apply for a Paid Review'),
        ...
        function getNextQuestionFromSection(section) {
            ...
            applications.post(request, 'applyforpaidreview/nextquestion').then(function (data) {
        ...
        function loadSettings() {
            applications.getFluid('applyforpaidreview/settings', { TestAttendanceId: vm.testAttendanceId() }).then(function (data) {
        ...
        function apply() {
			...
			applications.post(request, 'applyforpaidreview/apply').then(function (data) {
        ...
        function bindSpecialControl(question) {
            ...
            require([control], function (model) {
                var instance = model.getInstance({
					question: question,
					testAttendanceId: vm.testAttendanceId,
                    serviceName: 'applyforpaidreview',
                    naatiReference: "REV-" + vm.testAttendanceId(),
                    naatiUnitType: "Test Review Fee",
