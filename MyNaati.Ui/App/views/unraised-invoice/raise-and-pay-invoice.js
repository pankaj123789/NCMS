define(['services/requester'],
    function (requester) {
        var unraisedinvoices = requester('unraisedinvoices');
        var questionTypeControl = {};
        var lookups = {};

        questionTypeControl[ENUMS.AnswerTypes.Information] = 'views//unraised-invoice/payment-information';
        questionTypeControl[ENUMS.AnswerTypes.RadioOptions] = 'views/wizard/check-question';
		questionTypeControl[ENUMS.AnswerTypes.PaymentControl] = 'views/unraised-invoice/payment-control';
        ...
        var vm = {
            ...
            title: ko.observable('My Invoices > Make Payment'),
        ...
        function getNextQuestionFromSection(section) {
            ...
            unraisedinvoices.post(request, 'raiseandpayinvoice/nextquestion').then(function (data) {
        ...
        function loadSettings() {
            unraisedinvoices.getFluid('raiseandpayinvoice/settings', { credentialApplicationId: vm.credentialApplicationId() }).then(function (data) {
        ...
        function apply() {
            ...
            unraisedinvoices.post(request, 'raiseandpayinvoice/applyembedded').then(function (data) {
        ...
        function bindSpecialControl(question) {
            ...
            require([control], function (model) {
                var instance = model.getInstance({
					question: question,
                    credentialApplicationId: vm.credentialApplicationId,
                    serviceName: 'raiseandpayinvoice',
                    naatiReference: "APP-" + vm.credentialApplicationId(),
                    naatiUnitType: "Application Fee",
