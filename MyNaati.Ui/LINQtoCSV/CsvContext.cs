...
namespace MyNaati.Ui.LINQtoCSV
{
    ...
    public class CsvContext
    {
        ...
        /// </returns>
        public IEnumerable<T> Read<T>(string fileName, CsvFileDescription fileDescription) where T : new()
        {
        ...
        public IEnumerable<T> Read<T>(StreamReader stream) where T : new()
        {
        ...
        public IEnumerable<T> Read<T>(StreamReader stream, CsvFileDescription fileDescription) where T : new()
        {
            return ReadData<T>(null, stream, new CsvFileDescription());
        }
        ...
        private IEnumerable<T> ReadData<T>(
                    string fileName, 
                    StreamReader stream, 
                    CsvFileDescription fileDescription) where T : new()
        {
