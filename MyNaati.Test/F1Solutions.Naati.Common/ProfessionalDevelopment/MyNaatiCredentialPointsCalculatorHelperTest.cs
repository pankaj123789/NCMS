...
{
    public class MyNaatiCredentialPointsCalculatorHelperTest
    {
        ...
        public void GetCertificationPeriodDetails_WhenCalledAndCertificationPeriodHasNotBeenSubmitted_ThenCertificationPeriodForCredentialAreLoaded(CertificationPeriodStatus status, CertificationPeriodRecertificationStatus recertificationStatus, bool expectedDefault, bool expectedEditable, bool expectedCurrent)
        {
            ...
            var calculator = new MyNaatiCredentialPointsCalculatorHelper(logBookService, systemQueryService, personQueryService, businessLogicService, activityPointsCalculator);
        ...
        [Theory]
        [InlineData(CertificationPeriodStatus.Current, CertificationPeriodRecertificationStatus.BeingAssessed, true, false, false, false)]
        [InlineData(CertificationPeriodStatus.Current, CertificationPeriodRecertificationStatus.BeingAssessed, false, true, true, true)]
        [InlineData(CertificationPeriodStatus.Current, CertificationPeriodRecertificationStatus.Completed, true, false, false, false)]
        [InlineData(CertificationPeriodStatus.Current, CertificationPeriodRecertificationStatus.Completed, false, true, true, true)]
        [InlineData(CertificationPeriodStatus.Expired, CertificationPeriodRecertificationStatus.BeingAssessed, true, false, false, false)]
        [InlineData(CertificationPeriodStatus.Expired, CertificationPeriodRecertificationStatus.BeingAssessed, false, true, true, true)]
        [InlineData(CertificationPeriodStatus.Expired, CertificationPeriodRecertificationStatus.Completed, true, false , false, false)]
        ...
        [Fact]
        public void GetCertificationPeriodCredential_WhenCalled_ThenStartDateOFTheCredentialIsTakenAsStartDateForPointCalcualation()
        {
            var credentialId = 1111;
            var naatiNumber = 1234;
            var recertificationPeriodMonths = 3;
