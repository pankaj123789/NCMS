...
{
    public class NcmsActivityPointsCalculatorHelperTest
    {
        ...
        [Fact]
        public void
            CaluculatePointsFor_WhenUserDoesntHaveAValidCertificationPeriod_ThenZeroPointsAreAssignedForEachPDCategory()
        {
            ...
            var calculator = new NcmsActivityPointsCalculatorHelper(logbookQueryService, personQueryService,
                applicationQueryService, systemQueryService, businessService);



            //Act
            Assert.Throws<NullReferenceException>(() => calculator.CaluculatePointsFor(naatiNumber, certificationPeriodId));
            ;
        ...
        [Fact]
        public void CaluculatePointsFor_WhenUserHasMultipleActivities_ThenPointsAreCalculatred()
        {
            var naatiNumber = 12345;
        ...
        [Fact]
        public void CaluculatePointsFor_WhenCompletedActivityDateIsBeforeStartPeriod_ThenMaxPointPerYearsAreProperlyCalculated()
        {
            var naatiNumber = 12345;
            var pDTransitionStartDate = new DateTime(2014,01,01);
            var startCertficationPeriod = new DateTime(2018,01,01);
            var endCertficationPeriod = new DateTime(2019, 01, 19);
            ...
            var firstCategory = firstSection.Categories.First();
            firstCategory.PointsLismitTypeId = (int)PointsLimitTypeName.MaxPointsPerYear;
            firstCategory.PointsLimit = 10;


            var activities = new List<ProfessionalDevelopmentActivityDto>();

            var activity1 = GetBasicProfessionalDevelopmentActivityResponse(1, startCertficationPeriod.AddDays(-10), firstCategory.CategoryId);
            activity1.Points = 10;
            activities.Add(activity1);

            var activity2 = GetBasicProfessionalDevelopmentActivityResponse(2, startCertficationPeriod.AddDays(1), firstCategory.CategoryId);
            activity2.Points = 10;
            activities.Add(activity2);

            var activity3 = GetBasicProfessionalDevelopmentActivityResponse(3, startCertficationPeriod.AddDays(-100), firstCategory.CategoryId);
            activity3.Points = 10;
            activities.Add(activity3);

            var activity4 = GetBasicProfessionalDevelopmentActivityResponse(4, startCertficationPeriod.AddDays(100), firstCategory.CategoryId);
            activity4.Points = 10;
            activities.Add(activity4);

            var activity5 = GetBasicProfessionalDevelopmentActivityResponse(5, startCertficationPeriod.AddDays(-365), firstCategory.CategoryId);
            activity5.Points = 10;
            activities.Add(activity5);

            var activity6 = GetBasicProfessionalDevelopmentActivityResponse(6, startCertficationPeriod.AddDays(365), firstCategory.CategoryId);
            activity6.Points = 10;
            ...
            var expectedPoints = activity1.Points + activity2.Points + activity5.Points + activity6.Points;
            Assert.Equal(expectedPoints, result.Sections.First(x => x.SectionId == firstSection.SectionId).Points);
        ...
        public void CaluculatePointsFor_WhenEndDateIsDifferentToOriginalDate_ThenActiviesFromEndDateAreRequestedAndMinimumPointsAreCalcualatedWithEndDate()
        {
            ...
            var naatiNumber = 12345;
            var startCertficationPeriod = new DateTime(2019,5,28).AddYears(-1);
            var endCertficationPeriod = new DateTime(2019,5,28).AddDays(3);
        ...
        public void CaluculatePointsFor_WhenCertificationPeriodHasASubmittedRecertification_ThenAllAttachedActivitiesAreUsedToCalculateThePoints()
        {
            ...
            logbookQueryService.GetSubmittedRecertificationApplicationForPeriod(Arg.Is<int>(x => x == certificationPeriodId))
        ...
        [InlineData(CertificationPeriodStatus.Current, CertificationPeriodRecertificationStatus.BeingAssessed, true, true, false)]
        [InlineData(CertificationPeriodStatus.Current, CertificationPeriodRecertificationStatus.Completed, true, false, false)]
        [InlineData(CertificationPeriodStatus.Expired, CertificationPeriodRecertificationStatus.BeingAssessed, true, true, false)]
        [InlineData(CertificationPeriodStatus.Expired, CertificationPeriodRecertificationStatus.Completed, true, false, false)]
        ...
        public void GetCertificationPeriodDetails_WhenCalled_ThenTheCertificationPeriodWithTheProperStatusAreReturned(CertificationPeriodStatus status, CertificationPeriodRecertificationStatus recertificationStatus, bool expectedDefault, bool expectedEditable, bool expectedCurrent)
        {
            ...
            var calculator = new NcmsActivityPointsCalculatorHelper(logBookService, personQueryService, applicationQueryService, systemQueryService, businessLogicService);
