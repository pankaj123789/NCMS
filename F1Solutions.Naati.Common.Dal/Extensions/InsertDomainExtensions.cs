...
namespace NCMS.Bl.TestSpecifications.Extensions
{
    public static class InsertDomainExtensions
    {
                                        ...
                                        IList<F1Solutions.Naati.Common.Dal.Domain.TestComponentType> testComponentTypeDomains)
        {
            ...
            {
                throw new Exception($"An invalid TestComponentBaseTypeId ({testComponentTypeModel.TestComponentBaseTypeId}) was given.");
            }
                                        ...
                                        IList<F1Solutions.Naati.Common.Dal.Domain.TestComponentType> testComponentTypeDomains)
        {
            ...
            {
                throw new NullReferenceException($"An invalid TestComponentTypeName ({testComponentModel.TestComponentTypeName}) was given.");
            }
                                        ...
                                        IList<F1Solutions.Naati.Common.Dal.Domain.TestComponentType> testComponentTypeDomains)
        {
            ...
            if (testComponentTypeDomain == null)
            {
                throw new NullReferenceException($"An invalid TestComponentType ({testComponentTypeStandardMarkingSchemeModel.ComponentType}) was given.");
            }
                                        ...
                                        IList<F1Solutions.Naati.Common.Dal.Domain.RubricMarkingCompetency> rubricMarkingCompetencyDomains)
        {
            ...
            if (testComponentTypeDomain == null)
            {
                throw new NullReferenceException($"An invalid TestComponentType ({rubricMarkingCompetencyModel.ComponentType}) was given.");
            }
