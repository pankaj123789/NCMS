...
{
    public class CredentialLanguage1CacheQueryService : BaseCacheQueryService<int, LanguageLookup, LookupTypeDto>, ICredentialLanguage1CacheQueryService
    {
        ...
        protected override LookupTypeDto GetDbSingleValue(int key)
        {
            ...
            var response = practitioner.GetLookup(PractitionerLookupType.ActiveCredentialsLanguages1);
        ...
        {
            var practitioner = new PractitionerQueryHelper();
            var response = practitioner.GetLookup(PractitionerLookupType.ActiveCredentialsLanguages1).ToList();
