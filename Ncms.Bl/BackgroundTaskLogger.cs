...
//    internal class BackgroundTaskLogger : IBackgroundTaskLogger
//    {
//        private readonly StringBuilder _errors;
//        private readonly StringBuilder _warnings;
//        private readonly StringBuilder _detailedLog;

//        private readonly List<string> _processedPayments;
//        private readonly List<string> _processedInvoices;
//        private readonly List<string> _processedApplications;
//        private readonly PerformContext _dashBoardContext;
...
//        public BackgroundTaskLogger(PerformContext dashBoardContext) 
//        {
...
//        public string GetReportContent(NcmsJobTypeName taskName)
//        {
//            if (_errors.Length ==0
//                && _warnings.Length ==0 &&
...
//        private string BuildReport(NcmsJobTypeName taskName)
//        {
...
//                   $"</head> " +
//                   $"<body>" +
//                   $"<p><b>NCMS Batch {taskName} Report</b></p>" +
//                   $"{DateTime.Now}" +
//                   $"<br/>" +
