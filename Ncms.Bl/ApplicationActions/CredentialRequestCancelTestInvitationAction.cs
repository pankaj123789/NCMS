...
{
    public class CredentialRequestCancelTestInvitationAction : CredentialRequestStateAction
    {
        ...
        protected override CredentialRequestStatusTypeName CredentialRequestExitState => CredentialRequestStatusTypeName.EligibleForTesting;

        protected override SecurityNounName? RequiredSecurityNoun => SecurityNounName.TestSitting;
        protected override SecurityVerbName? RequiredSecurityVerb => SecurityVerbName.Uninvite;
