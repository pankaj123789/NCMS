...
{
    public class TestMaterialAttachmentFileDeletionGenerator : BaseFileDeletionGenerator
    {
        public TestMaterialAttachmentFileDeletionGenerator(FileDeletionRunner runner, string documentType, string entityType, int batchSize, int includeQueued, int documentTypeId)
