...
{
    class WorkPracticeAttachmentFileDeletionGenerator : BaseFileDeletionGenerator
	{
		public WorkPracticeAttachmentFileDeletionGenerator(FileDeletionRunner runner, string documentType, string entityType, int batchSize, int includeQueued, int documentTypeId)
