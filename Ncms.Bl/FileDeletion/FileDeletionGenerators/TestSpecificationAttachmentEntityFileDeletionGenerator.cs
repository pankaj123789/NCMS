...
{
    public class TestSpecificationAttachmentEntityFileDeletionGenerator : BaseFileDeletionGenerator
    {
        public TestSpecificationAttachmentEntityFileDeletionGenerator(FileDeletionRunner runner, string documentType, string entityType, int batchSize, int includeQueued, int documentTypeId)
