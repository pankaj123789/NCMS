...
{
    class CredentialApplicationAttachmentFileDeletionGenerator : BaseFileDeletionGenerator
    {
        public CredentialApplicationAttachmentFileDeletionGenerator(FileDeletionRunner runner, string documentType, string entityType, int batchSize, int includeQueued, int documentTypeId)
