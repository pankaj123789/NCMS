...
{
    class NoteAttachmentFileDeletionGenerator : BaseFileDeletionGenerator
    {
        public NoteAttachmentFileDeletionGenerator(FileDeletionRunner runner, string documentType, string entityType, int batchSize, int includeQueued, int documentTypeId)
