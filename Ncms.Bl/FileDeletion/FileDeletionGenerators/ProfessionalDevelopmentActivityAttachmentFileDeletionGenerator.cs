...
{
    class ProfessionalDevelopmentActivityAttachmentFileDeletionGenerator : BaseFileDeletionGenerator
    {
        public ProfessionalDevelopmentActivityAttachmentFileDeletionGenerator(FileDeletionRunner runner, string documentType, string entityType, int batchSize, int includeQueued, int documentTypeId)
