...
{
    class TestSittingDocumentFileDeletionGenerator : BaseFileDeletionGenerator
    {
        public TestSittingDocumentFileDeletionGenerator(FileDeletionRunner runner, string documentType, string entityType, int batchSize, int includeQueued, int documentTypeId)
