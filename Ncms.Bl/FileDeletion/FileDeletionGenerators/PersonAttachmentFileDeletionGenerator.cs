...
{
    class PersonAttachmentFileDeletionGenerator : BaseFileDeletionGenerator
	{
		public PersonAttachmentFileDeletionGenerator(FileDeletionRunner runner, string documentType, string entityType, int batchSize, int includeQueued, int documentTypeId)
