...
using System.Linq;
using F1Solutions.Naati.Common.Attributes;
using F1Solutions.Naati.Common.ServiceContracts.Services;

namespace NAATI.BusinessServices.API
{
    ...
    public class MaterialRequestMemberGroupingModel
    {
        ...
        public DateTime OldestApprovedDate => Items
            .SelectMany(y => y.Claims.Select(c => c.AprovedDate).Concat(y.Loadings.Select(l => l.AprovedDate)))
            .Max();
    ...
    public class MaterialRequestMemberPaymentClaimItemModel
    {
        ...
        [LookupDisplay(LookupType.NaatiUser)]
        public int AprovedByUserId { get; set; }
