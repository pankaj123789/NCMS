...
CREATE TABLE dbo.tblCredentialPrerequisite
	...
	ApplicationTypePrerequisiteId int NOT NULL
	)  ON [PRIMARY]
GO
...
GO
ALTER TABLE dbo.tblCredentialPrerequisite ADD CONSTRAINT
	FK_tblCredentialPrerequisite_tblCredentialType1 FOREIGN KEY
	(
...
GO
ALTER TABLE dbo.tblCredentialPrerequisite ADD CONSTRAINT
	FK_tblCredentialPrerequisite_tblCredentialApplicationType1 FOREIGN KEY
	(
