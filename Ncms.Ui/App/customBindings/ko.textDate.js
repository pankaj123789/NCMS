...
(function (factory) {
    ...
    function textDate(value) {
        ...
        if (typeof value == "string") {
            settings = { value: value, inputFormat: moment.ISO_8601, outputFormat: CONST.settings.shortDateDisplayFormat };
        }
        ...
        return moment(ko.toJS(settings.value), settings.inputFormat).format(settings.outputFormat);
    }
